...
variable "sso_root_volume_type" {
  description = "Type of the root volume"
  default     = "gp2"
}

variable "sso_root_volume_size" {
  description = "Volume size of the root partition"
  default     = "20"
}

variable "chqbook_sso_server_name" {
  default = "Prod_sso"
}

variable "chqbook_sso_instance_type" {
  default = "t2.medium"
}

variable "chqbook_sso_ami_id" {
